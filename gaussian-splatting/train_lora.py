...
if __name__ == '__main__':
    ...
    args.resolution = 1
    args.sparse_num = 3
    args.data_dir = f"./data/{dataset}/{target}"
    args.gs_dir = f"output/{dataset}/{target}"
    args.loo_dir = f"output/{dataset}/{target}_loo"
    args.bg_white = True
    args.sd_locked = True
    args.train_lora = True
    args.use_prompt_list = True
    args.add_diffusion_lora = True
    args.add_control_lora = True
